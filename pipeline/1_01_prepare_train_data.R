...
check_columns(data, docu_df, cols_excluded = columns_to_exclude_extra)
...
write_to_DB(con, "LM_data_14_17", data, docu_df)

# read data & check if identical
# data_DB <- read_from_DB(con, "LM_data_14_17", docu_df) %>% as_tibble()
# 
# identical(data %>% 
